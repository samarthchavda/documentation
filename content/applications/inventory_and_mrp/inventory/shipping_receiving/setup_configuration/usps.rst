...
the shipping connector form <inventory/shipping_receiving/usps-configuration>`. To create a new
...
- :guilabel:`CRID`: The CRID is a number that identifies your physical business address across all
